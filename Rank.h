...
class RANK {
    ...
    // This determines the rank busy until time, this is used to enforce timing parameters, such as maximum number of
    // bank activation per unit of time It also covers the time when the shared circutary between banks is used (e.g.,
